...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["amount"]))){
        ...
        if(!empty($member_id)){
            $current_balance = getMemberBalance($conn, $member_id);
            if($amount > $current_balance){
                $amount_err = "Insufficient balance. Available: ₱" . number_format($current_balance, 2);
            }
        }
    }
    ...
    <div class="col-md-9">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="mb-3">
                ...
                <select name="member_id" id="member_id" class="form-select <?php echo (!empty($member_id_err)) ? 'is-invalid' : ''; ?>">
            ...
            <div class="mb-3">
                <input type="submit" class="btn btn-warning" value="Record Withdrawal">
